...
// Add these to the bottom of components/ui/icons.tsx
...
export const Twitter = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" stroke="none" className={className}>
    <path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-12.7 15.8-2.6-1.2-4.6-4.2-4.6-4.2 2.6.4 5-1.5 5.8-2.5-2.3-.2-3.8-1.9-4-3.6 1 .2 1.9.1 1.9.1-2.4-.5-3.8-3-3.3-5.3 1.2.9 2.1 1 2.1 1-2-1.6-2-5.4.1-7 2.6 3.2 6.5 5 10.3 5.2 0-2.4 2.8-4.7 5.5-3 1.3-.3 2.5-.9 2.5-.9-.5 1.4-1.4 2.4-2.1 2.9 1.2-.1 2.3-.5 2.3-.5z" />
  </svg>
);

export const Github = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" stroke="none" className={className}>
    <path d="M12 2A10 10 0 0 0 2 12c0 4.4 2.9 8.2 7.1 9.6.5.1.7-.2.7-.5v-1.7c-2.8.6-3.4-1.4-3.4-1.4-.5-1.1-1.1-1.4-1.1-1.4-.9-.6.1-.6.1-.6 1 .1 1.5 1 1.5 1 .9 1.5 2.3 1.1 2.9.9.1-.6.4-1.1.7-1.4-2.2-.3-4.5-1.1-4.5-5 0-1.1.4-2 1-2.7-.1-.3-.4-1.3.1-2.7 0 0 .9-.3 2.8 1a9.8 9.8 0 0 1 5 0c1.9-1.3 2.8-1 2.8-1 .5 1.4.2 2.4.1 2.7.6.7 1 1.6 1 2.7 0 3.9-2.3 4.7-4.5 5 .4.3.7.9.7 1.9v2.8c0 .3.2.6.7.5A10 10 0 0 0 12 2z" />
  </svg>
);